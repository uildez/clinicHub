  ...
  return (
    <div className="flex lg:flex-row flex-col gap-8 lg:mt-28">
      <div className="grid md:grid-cols-3 grid-cols-1 gap-4">
        <Link to="consulta">
          <div className="bg-white px-6 py-4 rounded-2xl cursor-pointer text-blue-600 hover:scale-105 hover:text-slate-100 hover:bg-blue-800 text-left shadow-xl transition-all">
            <i className="fa-regular fa-calendar text-6xl"></i>
            <h2 className="font-bold text-xl mt-2">Agendar Consulta</h2>
          </div>
        </Link>

        <div className="bg-white px-6 py-4 rounded-2xl text-blue-600  opacity-50 text-left shadow-xl transition-all">
